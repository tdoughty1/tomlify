...
def test_special_floats_toml() -> None:
    ...
    expected_tokens = [
        ...
        "Token(type_=<TokenType.EQUAL: 'EQUAL'>, lexeme='=', literal=None, line=2)",
        "Token(type_=<TokenType.IDENTIFIER: 'IDENTIFIER'>, lexeme='inf', literal=None, line=2)",
        ...
        "Token(type_=<TokenType.IDENTIFIER: 'IDENTIFIER'>, lexeme='inf', literal=None, line=3)",
        ...
        "Token(type_=<TokenType.EQUAL: 'EQUAL'>, lexeme='=', literal=None, line=4)",
        "Token(type_=<TokenType.MINUS: 'MINUS'>, lexeme='-', literal=None, line=4)",
        "Token(type_=<TokenType.IDENTIFIER: 'IDENTIFIER'>, lexeme='inf', literal=None, line=4)",
        ...
        "Token(type_=<TokenType.EQUAL: 'EQUAL'>, lexeme='=', literal=None, line=7)",
        "Token(type_=<TokenType.IDENTIFIER: 'IDENTIFIER'>, lexeme='nan', literal=None, line=7)",
        ...
        "Token(type_=<TokenType.IDENTIFIER: 'IDENTIFIER'>, lexeme='nan', literal=None, line=8)",
        ...
        "Token(type_=<TokenType.EQUAL: 'EQUAL'>, lexeme='=', literal=None, line=9)",
        "Token(type_=<TokenType.MINUS: 'MINUS'>, lexeme='-', literal=None, line=9)",
        "Token(type_=<TokenType.IDENTIFIER: 'IDENTIFIER'>, lexeme='nan', literal=None, line=9)",
